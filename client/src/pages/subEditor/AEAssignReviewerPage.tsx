...
export default function AEAssignReviewerPage() {
  ...
  // Fetch paper info (reuse CE getAllPapers endpoint)
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    fetch(
      `${url}/chiefEditor/journals/${paper.journal_id}/staff?role=reviewer&paper_id=${paperId}`,
      { headers: { Authorization: `Bearer ${token}` } },
    )
      .then((r) => r.json())
      .then((data) => {
            ...
            {loading ? (
              ...
              <Card>
                <CardContent className="py-10 text-center text-muted-foreground">
                  No reviewers found for this journal.
                </CardContent>
              </Card>
            ) : (
              <>
          ...
          <div className="w-full lg:w-80 space-y-4 shrink-0">
            <Card>
              <CardContent className="pt-4 space-y-3">
                <p className="font-semibold text-sm">Invite New Reviewer</p>
